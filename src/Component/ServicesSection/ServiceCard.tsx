        ...
        <React.Fragment>
            <StyledApp container item direction="column" justify="center" alignItems="center" >
                ...
                <StyledServicesGrid className="servicesGrid" container item direction="column" justify="center" alignItems="center" >
                    ...
                    <Grid container className="icon-line1" direction="column" justify-lg-center spacing={1}>
                        ...
                        <Grid container className="icon-text" direction="row" justify-lg-center spacing={1}>
                            <Grid item lg={2}>
                                <Grid className="Styled-icon-title">{ServiceData.architech.title}</Grid>
                            </Grid>
                            <Grid item lg={2}>
                    ...
                    <Grid container className="icon-line2" direction="column" justify-lg-center spacing={1}>
                        <Grid container className="icon-img" direction="row" justify-lg-center spacing={1}>
                            <Grid item lg={2}>
                                <img src={ServiceData.constructionCompanies.imgsrc} alt="Construction Companies icon" height="74px" width="75px" />
                            </Grid>
                            ...
                            <Grid item lg={2} justify="center">
                                <img src={ServiceData.painters.imgsrc} alt="Painters icon" height="45px" width="38px" />
                            </Grid>
                            <Grid item lg={2}>
                                <img src={ServiceData.carpenters.imgsrc} alt="Carpenters icon" height="69px" width="68px" />
                            </Grid>
